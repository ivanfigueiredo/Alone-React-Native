...
import { infoUser, myCourse } from '../helpers/aloneAPI';
                ...
                <View style={styles.body2}>               
                    ...
                    >        
                        {
                           cursos.map((item, index) => { 
                               return(                                                       
                                    <Picker.Item style={styles.text} label={item.course} value={item} key={index} />                                                                                                                                    
                               );
                           }) 
                        }                                                                                                                                                                                    
                    </Picker> 

                    {
                        selectedCourse ?                    
                            ...
                            <Text style={styles.text}>Nota:{selectedCourse.grades}</Text>                        
...
Screen.navigationOptions = ({navigation}) => {
    return {
        headerRight: () => <Button title="Cursos" onPress={() => navigation.navigate('ListarProdutos')} />
    }
}
