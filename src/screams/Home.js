    ...
    return(
        <View style={home.container}>
            ...
            <View style={home.area}>
                <TouchableOpacity style={home.buttonHome} onPress={()=> {navigation.navigate('ListarProdutos')}}>
                    <Text style={{fontSize: 20, color:"#FFF"}}>Cursos</Text>
                </TouchableOpacity>
                <TouchableOpacity style={home.buttonHome} onPress={()=> {alert("Em construção")}}>
...
Home.navigationOptions = ({navigation}) => {
    return {
        headerRight: () => <Button title="Perfil" onPress={() => navigation.navigate('Perfil')} />
    }
  }
